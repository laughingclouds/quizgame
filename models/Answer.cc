...
{"question_id","uint64_t","integer",8,0,0,0}
};
...
Answer::Answer(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[2].empty() && pJson.isMember(pMasqueradingVector[2]))
    {
        ...
        {
            questionId_=std::make_shared<uint64_t>((uint64_t)pJson[pMasqueradingVector[2]].asUInt64());
        }
    }
}
...
void Answer::updateByMasqueradedJson(const Json::Value &pJson,
...
const std::shared_ptr<uint64_t> &Answer::getId() const noexcept
{
    return id_;
}
...
void Answer::setQuestionIdToNull() noexcept
{
    questionId_.reset();
    dirtyFlag_[2] = true;
}
...
bool Answer::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    if(pJson.isMember("id"))
    {
...
bool Answer::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Answer::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                              const std::vector<std::string> &pMasqueradingVector,
                                              std::string &err)
{
    if(pMasqueradingVector.size() != 3)
...
bool Answer::validJsonOfField(size_t index,
