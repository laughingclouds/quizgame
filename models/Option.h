...
public:
   ...
   */
  explicit Option(const drogon::orm::Row &r,
   ...
   */
  explicit Option(const Json::Value &pJson) noexcept(false);
...
private:
  friend drogon::orm::Mapper<Option>;
#ifdef __cpp_impl_coroutine
  friend drogon::orm::CoroMapper<Option>;
#endif
