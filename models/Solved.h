...
class Solved
{
  public:
     ...
     */
    explicit Solved(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Solved(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
